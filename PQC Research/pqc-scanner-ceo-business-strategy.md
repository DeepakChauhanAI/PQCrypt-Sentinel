...
|---|---|---|---|
| **SandboxAQ AQtive Guard** | SandboxAQ (spun out of Alphabet) | US | $5.75B valuation, DoD 5-year contracts |
| **Keyfactor Command + AgileSec + CipherInsights** | Keyfactor (acquired InfoSec Global + CipherInsights in 2025) | US | ABI Research #1 CLM 2025 |
| **AppViewX AVX ONE** | AppViewX | US | SaaS-first certificate lifecycle + PQC readiness |
| **CryptoNext COMPASS** | CryptoNext Security | France (Paris) | €12M raised, 2019, banking/financial focus |
...
| **Palo Alto Quantum-Safe Security** | Palo Alto Networks | US | Launched Jan 2026, network-edge PQC + cipher translation |
| **Venafi / CyberArk Certificate Manager** | CyberArk (acquired Venafi 2023) | US | Largest CLM base, PQC added 2025 |
...
- 12 public sector banks + 20+ private banks + 50+ NBFCs = addressable market
...
2. **Strong regulatory tailwinds** — RBI has not yet published a formal PQC mandate (as of March 2025), but the global G7 framework commits to 2030-2035 timelines, and Indian banks operating in UK/EU/US face those regulators
...
- **NIST FIPS 203/204/205** (Aug 2024) — the US deprecation timeline: RSA/ECDSA disallowed after 2030 (112-bit security) and 2035 (all). This is the global de facto standard.
- **NIST IR 8547** — explicit transition timeline
...
- **EU Commission mandate** — full cryptographic inventory by end of 2026 for all member state organisations
- **EU DORA** (Digital Operational Resilience Act) — financial services resilience, includes cryptographic references
- **US OMB M-23-02** — federal agencies must inventory and plan PQC migration
- **UK NCSC** — three-phase timeline: 2028 inventory -> 2031 priority migration -> 2035 full adoption
- **G7 banking coordination** — all G7 central banks committed to 2030-2035 PQC migration window for systemically important financial institutions
- **CMORG PQC Roadmap** (UK) — explicit guidance for financial institutions to begin PQC uplift immediately
- **RBI** — has not yet published a formal PQC mandate (as of March 2025) but the regulatory direction is clear; data localisation requirements already constrain procurement
- **SEBI, IRDAI** — likely to follow RBI and global G7 framework
